...
export const tempMailList: TempMail[] = [
  { id: '1', name: '10 Minute Mail', url: 'https://10minutemail.com/', description: '10分钟有效期' },
  { id: '2', name: 'Guerrilla Mail', url: 'https://www.guerrillamail.com/', description: '简单快速' },
  { id: '3', name: 'Temp Mail', url: 'https://temp-mail.org/', description: '自动刷新收件箱' },
  { id: '4', name: 'Mohmal', url: 'https://www.mohmal.com/zh', description: '支持阿拉伯语' },
  { id: '5', name: 'Fake Mail Generator', url: 'https://www.fakemailgenerator.com/', description: '批量生成' },
